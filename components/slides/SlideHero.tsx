    ...
    return (
        <SlideWrapper className="bg-gradient-to-br from-proteo-blue via-[#0a1525] to-black text-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 right-0 w-[600px] h-[600px] border border-white/20 rounded-full" />
                <div className="absolute top-20 right-20 w-[500px] h-[500px] border border-white/10 rounded-full" />
            ...
            <div className="relative z-10 max-w-5xl">
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-proteo-orange font-bold tracking-[0.3em] text-sm md:text-base uppercase">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.1] mb-8 tracking-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-proteo-accent to-blue-300">
                            Continuidad de su <br />Ecosistema Hídrico
                        </span>
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-300 font-light max-w-3xl leading-relaxed border-l-4 border-proteo-orange pl-6">
            ...
            <motion.div
                className="absolute bottom-16 left-1/2 transform -translate-x-1/2 text-slate-400 flex flex-col items-center gap-3"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1, y: [0, 10, 0] }}
                transition={{ delay: 1, duration: 2, repeat: Infinity }}
            >
                <span className="text-xs uppercase tracking-[0.2em] font-medium">Desliza para descubrir</span>
